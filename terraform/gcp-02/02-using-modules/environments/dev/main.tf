...
module "web_server_frontend_1" {
  source = "../../modules/compute"

  instance_name = "${var.environment}-frontend-server-01"
...
module "web_server_frontend_2" {
  source = "../../modules/compute"

  instance_name = "${var.environment}-frontend-server-02"
  machine_type  = "e2-micro"
  zone          = "asia-southeast2-a"
